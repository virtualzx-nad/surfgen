...
C
      DIMENSION BUFFER(NWORDS)
C
       WRITE(6,1000) FILE,NWORDS,IADR
 1000 FORMAT(' RREAD:    FILE',I3,I12,' WORDS','  IADR ',i12)
C
...
c
      reclen=1024
      fword=(iadr-1)*reclen+1
      WRITE(6,12) FILE,NWORDS,IADR
   12 FORMAT(' RWRIT:  FILE',I3,I12,' WORDS','  IADR ',i12)
...
CBHL  FUNCTION DOTT(A,NA,B,NB,N)
      REAL*8 FUNCTION DOTT(A,NA,B,NB,N)
      IMPLICIT REAL*8 (A-H,O-Z)
      DIMENSION A(1),B(1)
      DATA ZERO / 0.0D+00 /
C
