...
!PRINT *,"F,V=",F,V
 ...
 SUBROUTINE writeHd(filename,flheader,writedef)
   IMPLICIT NONE
   CHARACTER(72),INTENT(IN)         :: filename,flheader
   ...
   write(SURFOUT,1000)'SURFGEN.GLOBAL Hd COEFFICIENTS FILE'
 ...
 SUBROUTINE readHd(filename)
   ...
   read(SURFIN,1000)comment!'SURFGEN.GLOBAL Hd COEFFICIENTS FILE'
